function fileName = fit_cylinderBD_cylinderBD_ball_02(paramsFolder, ...
...
modelName = 'cylinderBD-tensorBD-tensor-02';
...
%     model.addConstraint('vol1 >= 0.5');
%     model.addConstraint('comp1_diffPar <= 1.5e-9');
%     model.addConstraint('comp1_diffPar >= 0.5e-9');
%     model.addConstraint('comp2_diffPar >= 1.8e-9');
%     model.addConstraint('comp2_r = 0.1e-6');
    model.addConstraint('comp1_kappa1 >= comp1_kappa2');
    model.addConstraint('comp2_kappa2 = comp1_kappa2');
    model.addConstraint('comp2_kappa1 = comp1_kappa1');
    ...
    model.addConstraint('comp2_vic = vol1/(vol1+vol2)');
    model.addConstraint('comp3_phi = comp1_phi');
    model.addConstraint('comp3_theta = comp1_theta');
    model.addConstraint('comp3_alpha = comp1_alpha');
    model.addConstraint('comp3_diffPar >= 2.0e-9');
    model.addConstraint('comp3_diffPar >= comp1_diffPar');
    %model.addConstraint('comp2_diffPar = (1-vol1)*2.4e-9');
%     model.addConstraint('comp3_diff = comp2_diffPar*(1-vol1-vol2)');
