function fileName = fit_cylinderBD_tensor_01(paramsFolder, ...
...
modelName = 'cylinderBD-tensor-01';
...
tic;
for thisPxl = 148%1:nPxlTot
%for thisPxl = 148
    data = s(:,thisPxl);

    cmp1 = cylinderBD();                   % intracellular spcae
    cmp1.set('nBinsTheta', 10);
    cmp1.set('nBinsPhi', 10);
    cmp2 = tensor();                          % extracellular space
