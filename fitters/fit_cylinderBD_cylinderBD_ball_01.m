function fileName = fit_cylinderBD_cylinderBD_ball_01(paramsFolder, ...
...
modelName = 'cylinderBD-cylinderBD-ball-01';
...
%for thisPxl = 148
    ...
    cmp2 = cylinderBD();                     % extracellular space
...
%     model.addConstraint('vol1 >= 0.5');
    ...
    model.addConstraint('comp3_diff = comp2_diffPar');
