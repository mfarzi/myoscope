function fileName = fit_zeppelin_tensor_ball_01(paramsFolder, ...
...
modelName = 'zeppelin-tensor-ball-01';
...
parfor thisPxl = 1:nPxlTot
    ...
    model.addConstraint('comp1_theta = comp2_theta');
    model.addConstraint('comp1_phi   = comp2_phi'  );

    model.addConstraint('comp3_diff = 2.4e-9');
    
    model.addConstraint('comp3_diff >= comp1_diffPar');
    
    model.addConstraint('comp1_diffPar = comp2_diffPar');
    model.addConstraint('comp1_diffPar = comp2_diffPerp1');
